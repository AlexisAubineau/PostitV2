...
public class Messages extends AppCompatActivity
        ...
        authListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user == null) {
                    ...
                    startActivity(new Intent(Messages.this, LoginActivity.class));
                    finish();
                }
            }
        };
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.home) {
            ...
            Intent intent = new Intent(Messages.this, Profil.class);
            startActivity(intent);
        }
        else if (id == R.id.friends) {
            Intent intent = new Intent(Messages.this, Amis.class);
            startActivity(intent);
        }
            ...
            Intent intent = new Intent(Messages.this, Albums.class);
            startActivity(intent);
        }
